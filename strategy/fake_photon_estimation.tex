...
\begin{figure}
  \centering
  \subfigure [$m_{\PZ\Pl}$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/ZL_mass_pow.pdf}}%
  \subfigure [$\pt$ of $\Pl^0$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/Z_l0_pt_pow.pdf}}%
  \subfigure [Number of $\PGg^{\rm kinematic}$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/kinPh_central_N_pow.pdf}}
...
\begin{figure}
  \centering
  \subfigure [$\pt   $ of $\PGg^{\rm fail}$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/lead_fail_pt_fine_pow.pdf}}%
  \subfigure [$|\eta|$ of $\PGg^{\rm fail}$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/lead_fail_aeta_fine_pow.pdf}}%
  \subfigure [$\sieie$ of $\PGg^{\rm fail}$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/lead_fail_sieie_pow.pdf}}
...
\begin{figure}
  \centering
  \subfigure [$\pt   $ of $\PGg^{\rm pass}$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/lead_loose_pt_fine_pow.pdf}}%
  \subfigure [$|\eta|$ of $\PGg^{\rm pass}$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/lead_loose_aeta_fine_pow.pdf}}%
  \subfigure [$\sieie$ of $\PGg^{\rm pass}$] {\includegraphics[width=.333333333\textwidth]{dataMC/Run2/fullMC/CRLFR/lead_loose_sieie_pow.pdf}}
  \caption{Transverse momentum, pseudorapidity and \sieie of photons
...
\begin{figure}
\centering
\includegraphics[height=.33\textheight]{Figures/FR_VLtoL_pt-aeta_data-ZGToLLG_binEvol.pdf}
...
%% \begin{figure}
%%   \centering
%%   \subfigure [$\pt   $ of $\PGg^{\rm pass}$] {\includegraphics[width=.333333333\textwidth]{dataMC_noLFR/Run2/fullMC/CR2P2F/lead_wp90_pt_fine_pow.pdf}}%
%%   \subfigure [$|\eta|$ of $\PGg^{\rm pass}$] {\includegraphics[width=.333333333\textwidth]{dataMC_noLFR/Run2/fullMC/CR2P2F/lead_wp90_aeta_fine_pow.pdf}}%
%%   \subfigure [$\sieie$ of $\PGg^{\rm pass}$] {\includegraphics[width=.333333333\textwidth]{dataMC_noLFR/Run2/fullMC/CR2P2F/lead_wp90_sieie_pow.pdf}}
%%   \caption{Transverse momentum, pseudorapidity and \sieie of photons
%%     passing the \texttt{wp90} working point of the MVA based ID
%%     in lepton control region where both leptons from $\PZ_2$ fail the tight selection,
%%     integrated on the whole \Run2 period.}
%%   \label{fig:CRLFR_lead_pass}
%% \end{figure}
