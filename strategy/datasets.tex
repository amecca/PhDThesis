...
are also applied in the region $m_{ZZ} > 2m_{Z}$, where they have been computed.
...
Similarly to $\PQq\PAQq \to \PZ\PZ \to 4\Pl$, k-Factors are applied as function of $m_{\PZ\PZ}$~\cite{Catani_2007,Melnikov_2015}.
