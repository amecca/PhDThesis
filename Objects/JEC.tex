...
%% The corrections, parametrised as function of \pt and $\eta$ of the jets, are applied following the standard procedure used by most of the CMS analyses \cite{CMS:JEC_2011, CMS-DP-2016-020, CMS-DP-2021-033}.
...
%% They are derived from the simulation of QCD multi-jet events processed with or without pile-up overlay
