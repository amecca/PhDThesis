...
% The neutral particles are included only if they have $\pt > 0.5\GeV$, while charged particles are required to have $\pt > 0.2 \GeV$.
...
\begin{figure}
  \centering
  \subfigure [Transverse momentum] {\includegraphics[width=.333333333\textwidth]{Figures/VVGammaAnalyzer/Run2/lepCR/SR4P/lead_fsrPhotons_pt_pow.pdf}}%
  \subfigure [Pseudorapidity]      {\includegraphics[width=.333333333\textwidth]{Figures/VVGammaAnalyzer/Run2/lepCR/SR4P/lead_fsrPhotons_aeta_pow.pdf}}%
  \subfigure [Distance to lepton]  {\includegraphics[width=.333333333\textwidth]{Figures/VVGammaAnalyzer/Run2/lepCR/SR4P/lead_fsrPhotons_dRl_pow.pdf}}%
  \caption{Distributions of the transverse momentum, pseudorapidity and $\DR$ distance to the lepton
  of FSR photons associated with a lepton in the inclusive region with four charged leptons for \RunII.}
