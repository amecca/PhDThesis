...
\begin{figure}
  \centering
  \hfill
  \subfigure [Barrel] {\includegraphics[width=.4\textwidth]{Figures/VVGammaAnalyzer_noLFR/Run2/fullMC/CR2P2F/kinPh_phIso_EB_pow.pdf}}
  \hfill
  \subfigure [Endcap] {\includegraphics[width=.4\textwidth]{Figures/VVGammaAnalyzer_noLFR/Run2/fullMC/CR2P2F/kinPh_phIso_EE_pow.pdf}}
  \hfill\mbox{}
