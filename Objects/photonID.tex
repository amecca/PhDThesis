...
For this reason, the thresholds applied on the isolation quantities are frequently parameterized as a function of the particle \ET.
...
of the \pileup{} transverse energy density on the object $\eta$ \cite{CMS:electron-performance-2015}.
...
\begin{figure}
  \centering
  \hfill
  \subfigure [Barrel] {\includegraphics[width=.333333333\textwidth]{Figures/dataMC_noLFR/Run2/fullMC/CR2P2F/kinPh_phIso_EB_pow.pdf}}
  \hfill
  \subfigure [Endcap] {\includegraphics[width=.333333333\textwidth]{Figures/dataMC_noLFR/Run2/fullMC/CR2P2F/kinPh_phIso_EE_pow.pdf}}
  \hfill\mbox{}
...
\begin{figure}
  \centering
  \hfill
  \subfigure [Barrel] {\includegraphics[width=.333333333\textwidth]{Figures/dataMC_noLFR/Run2/fullMC/CR2P2F/kinPh_sieie_EB_pow.pdf}}%
  \hfill
  \subfigure [Endcap] {\includegraphics[width=.333333333\textwidth]{Figures/dataMC_noLFR/Run2/fullMC/CR2P2F/kinPh_sieie_EE_pow.pdf}}
  \hfill\mbox{}
