...
Links between clusters belonging to different calorimeters (preshower, ECAL and HCAL) are created if the position of the cluster in the more granular detector is within the area of the other.
