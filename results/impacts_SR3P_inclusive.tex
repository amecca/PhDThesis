...
%% {I checked, and it is NOT applied to the signal, like I did in June last year for 4L (Gullielmo's comment).
...
%% \begin{figure}
%%   \centering
%%   \subfigure [] {\includegraphics[width=.495\textwidth]{Figures/SYS/SR3P/WZTo3LNu_mWZGloose_QCDscale.pdf}\label{fig:debug_SR3P_WZTo3LNu_QCDScale}}
%%   \subfigure [] {\includegraphics[width=.495\textwidth]{Figures/SYS/SR3P/ZGToLLG_mWZGloose_QCDscale.pdf}\label{fig:debug_SR3P_ZGToLLG_QCDScale}}
%%   \caption{Effect of the QCD scale systematic on $\PW\PZ$ (left) and $\PZ\PGg$ in SR3P ($m_{\PW\PZ\PGg}$)}
%% \end{figure}
% </DEBUG>
