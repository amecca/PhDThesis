...
\begin{figure}
  \centering
  \subfigure [] {\includegraphics[width=.499\textwidth]{Figures/SYS/SR3P/WZTo3LNu_mWZGloose_QCDscale.png}\label{fig:debug_SR3P_WZTo3LNu_QCDScale}}
  \subfigure [] {\includegraphics[width=.499\textwidth]{Figures/SYS/SR3P/ZGToLLG_mWZGloose_QCDscale.png}\label{fig:debug_SR3P_ZGToLLG_QCDScale}}
