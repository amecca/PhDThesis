...
The likelihood scans and the study of the impact of each systematic uncertainty is performed
using an Asimov dataset, under the hypothesis that the signal strength is exactly 1,
for each of the strategies.
The results are reported in Appendix~\ref{sec:expected_4L_inclusive}.
