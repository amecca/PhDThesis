...
\begin{table}
  ...
  \begin{tabular}{l >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$}}
    ...
    \midrule
    $\PZ\PZ\PGg\to4\Pl\PGg$       &  1.962 \pm 0.047 &  1.714 \pm 0.040 &  4.021 \pm 0.100 &  5.864 \pm 0.142 &  13.561 \pm 0.184 \\
    \qqZZname                     &  0.243 \pm 0.011 &  0.210 \pm 0.009 &  0.610 \pm 0.018 &  0.858 \pm 0.025 &   1.921 \pm 0.034 \\
...
\begin{table}
  ...
  \begin{tabular}{l >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$}}
    ...
    \qqZZname                     &  0.192 \pm 0.009 &  0.158 \pm 0.008 &  0.452 \pm 0.015 &  0.652 \pm 0.022 &  1.453 \pm 0.029 \\
...
\resizebox{\textwidth}{!}{%
  \begin{tabular}{l >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$}}
    ...
    \qqZZname                     &  2.400 \pm 0.033 &  2.283 \pm 0.030 &  6.428 \pm 0.058 &   9.507 \pm 0.084 &  20.617 \pm 0.111 \\
...
\resizebox{\textwidth}{!}{%
  ...
  qqZZname                      &  0.103 \pm 0.007 &  0.085 \pm 0.006 &  0.235 \pm 0.011 &  0.328 \pm 0.016 &  0.751 \pm 0.021 \\
...
\resizebox{\textwidth}{!}{%
  \begin{tabular}{l >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$}}
    ...
    \qqZZname                    &   0.009 \pm 0.002 &  0.007 \pm 0.002 &   0.015 \pm 0.003 &    0.023 \pm 0.004 &    0.054 \pm 0.006 \\
...
\begin{table}
  ...
  \begin{tabular}{l >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$}}
    ...
    \qqZZname                    &  0.197 \pm 0.010 &  0.167 \pm 0.008 &  0.504 \pm 0.016 &  0.701 \pm 0.023 &  1.569 \pm 0.031 \\
...
\begin{table}
  ...
  \begin{tabular}{l >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$} >{$}r<{$}}
    ...
    \qqZZname                     &  0.09 \pm 0.01  &  0.07 \pm 0.00  &  0.21 \pm 0.01  &  0.29 \pm 0.01  &  0.66 \pm 0.02 \\
