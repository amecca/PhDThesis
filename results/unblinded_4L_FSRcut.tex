...
\begin{table}
  \caption{Post-fit yields in the triboson fiducial region in the four lepton channel,
    ...
    and estimating the \nonprompt photon background from simulation.}
...
\footnotetext{This is the additional normalization uncertainty, discussed at the beginning of Section~\ref{sec:strategy_description}.}
...
\begin{equation*}
\sigma^{\PZ\PZ\PGg}_{\text{measured}} =
