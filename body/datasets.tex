...
\providecommand{\mgNLO}{MadGraph5\_aMCatNLO}
...
%% $\PW\PZ$ is simulated at NLO with \mgNLO with up to 1 additional jet, including off-shell contributions.
...
$\Pg \Pg \to \PZ\PZ$ is simulatet, separately for the three final states 4\Pe, 2\Pe\PGm and 4\PGm, at LO with MCFM 7.0.

$\PW\PZ \to 3\Pl \PGn$, $\PZ \PGg \to 2\Pl \PGg$ and $\PZ \to \Pl \Pl$ (Drell-Yan), with \Pl = \Pe, \PGm, \PGt,
are simulated at NLO with \mgNLO, including off-shell effects.
...
Rare backgrounds such as massive triboson VVV and the various $\PQt\PAQt \,+\, X$ are simulated at NLO with MadGraph5\_aMCatNLO.
