...
%Appendix~\ref{sec:ggzznew}.
the next section.
% {\color{red} \FIXME A new official sample with up to 2 jets at matrix element is being studied. If ready in time it will replace the current one.}
...
\begin{sidewaystable}
  \caption{List of signal and background samples used in the analysis.}
