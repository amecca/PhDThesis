...
\begin{table}
  ...
  \caption{
    ...
    These values are taken from the Monte Carlo samples used in the analysis,
    which are produced with \MGvATNLO~\cite{MGatNLO, Frederix_2018} as described in Section~\ref{sec:simulation}.
  }
