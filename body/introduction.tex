...
\begin{figure}[ht]
  \centering
  \subfigure[$\mathrm{WWWW}$]          {\includegraphics[width=.2\linewidth]{Figures/quartic_WWWW.pdf}}
  \subfigure[$\mathrm{WWZZ}$]          {\includegraphics[width=.2\linewidth]{Figures/quartic_WWZZ.pdf}}
  \subfigure[$\mathrm{WWZ\gamma}$]     {\includegraphics[width=.2\linewidth]{Figures/quartic_WWZG.pdf}}
  \subfigure[$\mathrm{WW\gamma\gamma}$]{\includegraphics[width=.2\linewidth]{Figures/quartic_WWGG.pdf}}
...
\begin{figure}[th]
  \centering
  \subfigure[]                                 {\includegraphics[width=.24\linewidth]{Figures/triboson_quarkline_VVV.pdf}}
  \subfigure[]                                 {\includegraphics[width=.24\linewidth]{Figures/triboson_H_VVV.pdf}}
  \subfigure[\label{fig:triboson_feynman:TGC}] {\includegraphics[width=.24\linewidth]{Figures/triboson_TGC_VVV.pdf}}
  \subfigure[\label{fig:triboson_feynman:QGC}] {\includegraphics[width=.24\linewidth]{Figures/triboson_QGC_VVV.pdf}}
...
This thesis a study of triboson production with two massive bosons and a photon is presented.
...
Triboson production is an extremely rare process, as highlighted by the cross sections reported in Table \ref{tab:xsection-inclusive}.
...
In addition the leptonic decay of a W boson produces a charged lepton and a neutrino, but the latter cannot be detected in any current particle collider experiment.
...
called ``missing transverse momentum'' ($\overrightarrow{\slashed{p}_T}$), ``missing transverse energy'', or sometimes just ``missing energy'' ($\slashed{E}_T$), abbreviated as MET.
Since the measurement of the MET is by its nature indirect, the errors associated with it are higher than for every other reconstructed entity.
As a result, any search for leptonic decays of W bosons must deal with MET, that increases the complexity of the reconstruction,
especially in the case of two W, and is present in many different processes besides triboson production, thus increasing the background sources.
...
\begin{table}
  ...
  \begin{tabular}{ l c r }
    ...
    \midrule
    $pp \rightarrow ZZ\gamma$ & \todo{xx.x} fb & \todo{xxxx} \\
    $pp \rightarrow WZ\gamma$ & \todo{xx.x} fb & \todo{xxxx} \\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}
  ...
  \begin{tabular}{ l l c r } % l -> divide intermediate and final state
    \toprule
