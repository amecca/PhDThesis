...
\begin{description}
  ...
  \item[\textsc{Pede}] This is an independent Fortran programme that solves the linear equation system needed for the alignment.
    It uses the \textsc{Mille} output to perform the local fits and construct the global matrix $C'$.
...
and the implementation of constraints such as mass vertex constraints.
