...
\todo{cite one or more ZZ analyses which uses this method; preferably also the first.}
...
\todo{prompt $Z\gamma$ subtraction}
The main processes in the fake rate measurement region are Drell-Yan and $\PZ\PGg$, as can be see in Figure \todo{ref}.
...
\todo{Add data/MC of CRLFR to show that the main processes are DY and ZG.}
...
to the total.
This measurement is done separately for endcap and barrel, for several bins of \pt (Figure \todo{add}).
...
\todo{Move to appendix? --> The results of these cross checks are in Appendix...}
