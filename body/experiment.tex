...
In High Energy Physics (HEP), the particle polar direction is often described with its rapidity, defined as:
\begin{equation}
...
operating at temperatures of around -15 \Celsius and -20 \Celsius, respectively, to minimise ionising radiation damage.
...
During the last period of data taking of 2017, called era F, 5 \% of the converter had failed and 35 \% were damaged (but working) due to the radiation damage aggravated by a design problem, and were successfully replaced during the 2017-2018 end-of-year technical stop \cite{CMS:dcdc-failure-short}.
...
\note{Maybe move to chapter Dataset, as this is only needed to justify the division of year 2016.}
