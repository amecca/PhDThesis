...
LHC was designed to accelerate protons up to 7\TeV ($\sqrt{s} = 14\TeV$), and has successfully operated at 3.5 and 4\TeV during Run\usep 1 (2009-2013), at 6.5\TeV during \RunII (2015-2018) and 6.8\TeV during the ongoing Run\usep 3 (started in 2022).
...
This in turns allows for the suppression of the background from pileup interactions, and a handle for measuring particle lifetimes.
